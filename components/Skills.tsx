...
const Skills = (props: Props) => {
  return (
    <motion.div
      ...
      className="bg-[#cae3fb] mt-24 flex relative flex-col text-center md:text-left xl:flex-row mx-auto items-center max-w-[2000px] xl:px-10 min-h-screen justify-center xl:space-y-0"
    >
